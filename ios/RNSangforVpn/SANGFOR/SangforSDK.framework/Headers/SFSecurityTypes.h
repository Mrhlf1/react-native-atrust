...
{
    SFSDKModeSupportVpn               = 1<<0,                                           //SDK启用VPN接入功能
    SFSDKModeSupportSandbox           = 1<<1,                                           //SDK启用安全沙箱功能
    SFSDKModeSupportVpnSandbox        = SFSDKModeSupportVpn|SFSDKModeSupportSandbox,    //SDK启动VPN和安全沙箱功能
    SFSDKModeSupportMutable           = 1<<2 | SFSDKModeSupportVpnSandbox,              //SDK启动模式会根据配置变动
};
...
typedef NS_ENUM(NSInteger, SFAuthType)
{
    ...
    SFAuthTypeTokenRadius       = 26,        //radius令牌认证
    SFAuthTypeTokenHttps        = 27,        //https令牌认证
